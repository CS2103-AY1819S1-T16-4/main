...
** What it does: Collect and preprocess academic major and module information from https://nusmods.com[NUSMods],
...
** Highlight:
*** This requires a clear understanding of the types of information about academic majors and module 
