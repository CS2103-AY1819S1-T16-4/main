...
=== Major enhancement
* Implement mechanism to retrieve NUs major and module information
** What it does: Collect and preprocess major and module information from https://nusmods.com[NUSMods],
...
information about NUS majors and modules to function.
** Highlight:
