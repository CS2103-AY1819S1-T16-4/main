...
=== Major enhancement
* Compile module and major information into JSON file and package it into the
JAR file for use of the application.
** What it does: Information about NUS modules and majors is the foundation of all commands in Module
Planner.
** Justification:
** Highlight:
