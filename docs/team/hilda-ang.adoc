...
This project portfolio showcases the contributions I have made in a team project under CS2103T Software Engineering. I worked in a team of four COmputer Science students to develop a product named ModulePlanner that is built on top of an existing software (AddressBook - Level 4).

ModulePlanner is a desktop application made to help NUS Computer Science and Computer Engineering undergraduate students plan their modules. It is designed to be used mainly through a Command Line Interface (CLI), although it also provides a Graphical User Interface (GUI).
...
The next few sections describe my contributions to the project.
...
* *Minor enhancement*: added the ability *list modules that the user has taken*
