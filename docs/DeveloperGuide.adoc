...
When the user sets up their focus area, additional field(s) of `Focus_Area_Requirement` will be added to the status, depending on the number of focus
areas that the user have. If the user sets up for 2 focus areas, then there will be 2 new fields.

==== Design Considerations
Currently the status doesn't track of Unrestricted Elective requirement because of the complexity of how it is counted. Credits
...
would be to list down all modules with more than 4 credit count that transfer its extra credits to UE credits and takine them into consideration.
