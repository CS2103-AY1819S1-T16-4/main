...
* **Alternative 1 (current choice)**: Use `ModuleInfo` class to represent module information that is transparent to user's major
and `ModuleDescription` class to represent module information that is specific to the requirements of a major.
...
** Cons: Commands that need module information specific to a major (e.g. `suggest` and `status`) still need
