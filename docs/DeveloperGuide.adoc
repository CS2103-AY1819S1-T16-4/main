...
The list mechanism displays either a list of modules that the user has added to a specified year or a list of all modules that the user has added to every year. It is facilitated by `ModulePlanner`. The `ModulePlanner` stores a list of all `Semester` s and each `Semester` stores a list `modulesTaken` containing modules that the user has added to that `Semester`.
