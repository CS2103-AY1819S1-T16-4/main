...
public class SystemTestSetupHelper {
     ...
     */
    public TestApp setupApplication(Supplier<ReadOnlyModulePlanner> modulePlanner, Path saveFileLocation) {
        try {
            FxToolkit.registerStage(Stage::new);
            FxToolkit.setupApplication(() -> testApp = new TestApp(modulePlanner, saveFileLocation));
